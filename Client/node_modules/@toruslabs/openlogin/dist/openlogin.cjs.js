...
/* harmony import */ var _toruslabs_eccrypto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
var external_lodash_merge_ = __webpack_require__(11);
...
class Modal_Modal {
  ...
  async initIFrame(src) {
    ...
    const documentIFrameElem = document.getElementById(constants["f" /* modalDOMElementID */]);
...
var OpenLoginStore = __webpack_require__(8);
...
/* harmony import */ var pump__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
...
class OpenLoginStore_OpenLoginStore {
  ...
  get(key) {
    const store = JSON.parse(this.storage.getItem(constants["g" /* storeKey */]));
    return store[key];
  }
...
/* harmony import */ var _IStore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
...
/* harmony import */ var _OpenLogin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
/* harmony import */ var _OpenLoginStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
...
/* harmony import */ var _Provider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
