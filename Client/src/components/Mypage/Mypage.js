    ...
    <div className="MyPage_App">
      <div className="MyPage_one">
        <div className="MyPage_Title">
          ...
          <div className="MyPage_explain">MyPage</div>
            ...
            {account ? (
              <div>
                ...
                <div>
                  ...
                  />
                  <button
                    className="MyPage_title_button2"
                ...
                <div className="MyPage_title_text">
                  ...
                  <button
                    className="MyPage_title_button3"
              ...
              <button className="MyPage_title_button" onClick={connectWallet}>
        ...
        <div className="MyPage_lists"></div>
      </div>
      ...
      <div className="MyPageChar_App">
        ...
        <div className="MyPageChar_form">
          ...
          <div className="MyPageChar_address">나의 계정주소 : {account}</div>
