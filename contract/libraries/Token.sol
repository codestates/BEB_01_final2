...
contract Token is TokenInterface {
    ...
    function transfer(address from, address recipient, uint amount) public virtual override isMint(from) isMint(recipient) 
    returns (bool) {
    ...
    function _burn(address account, uint256 amount) internal virtual isMint(account){
