...
contract NFT is IERC721, IERC721Metadata, ERC165 {
    ...
    function getNFT_Address(address _address) public view returns(string[] memory){
    ...
    function nftTransferFrom( address from, address to, uint256 tokenId) public virtual override {
        require(
    ...
    function _nftTransfer( address from, address to, uint256 tokenId) internal virtual {
        require(
    ...
    function NFTbalanceOf(address owner)public view virtual override returns (uint256){
    ...
    function nftApprove(address to, uint256 tokenId) external virtual override returns (bool) {
        address owner = NFT.ownerOf(tokenId);
